...
//ucz sie, czyli:
void Perceptron::learn(const int inputs[],int expectedResult) {
...
int Perceptron::getResult(const int inputs[])
{
	double sum=0;
...
void Perceptron::changeWeights(int actualResult,int desiredResult,const int inputs[])
{
	for(int i=0; i<this->numberOfInputs; i++)
