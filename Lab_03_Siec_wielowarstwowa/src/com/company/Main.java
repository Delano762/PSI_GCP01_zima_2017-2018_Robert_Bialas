...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        backPropagation.setMaxError(0.014);
        backPropagation.setLearningRate(0.8);

        //utworzenie sieci wielowarstwowej i ustalenie ilości warstw ukrytych
        MultiLayerPerceptron multiLayerPerceptron = new MultiLayerPerceptron(TransferFunctionType.SIGMOID, 2,5,10,1);
